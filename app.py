...
def load_data(data):
	df = pd.read_csv(data, usecols=[2, 3], dtype={'properties.identifier.value': str,'properties.short_description': str}, nrows=100) # Select organization name and description columns
