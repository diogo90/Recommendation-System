...
def load_data(data):
	df = pd.read_csv(data, usecols=[7, 10],  dtype={'properties.identifier.value': str,'properties.short_description': str}) # Select organization name and description columns
...
def main():
	...
	df = load_data("C:/Users/diogo/OneDrive/Ambiente de Trabalho/Github/Data-Engineering/london_organizations_crunchbase_nov_22.csv") # Load dataset
